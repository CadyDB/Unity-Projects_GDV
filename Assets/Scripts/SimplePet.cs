...
{
    [Header("Pet Info")]
    public string petName = "Lilo";
    public string petType = "Cat";
    public int petAge = 4;
    public int petWeight = 5;
    ...
    void Start()
    {
        ...
        Debug.Log("Controls: F = Feed | P = Play | S = Sleep | I = Info | A = Give Medicine");
        ShowPetInfo();
    }
    ...
    void Update()
    {
        ...
        if (Input.GetKeyDown(KeyCode.A))
            ...
            if (isSick)
            {
                Debug.Log(petName + "was given Medicine.");
                energy += 30;
                if (energy > 100) energy = 100;
            }
            else
            {
                Debug.Log(petName + "feels better!");
            }
